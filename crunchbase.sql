...
CREATE TABLE posts (user_id TEXT, post_id TEXT, created_time TIMESTAMP, message TEXT);

copy posts from '/Users/davidwen/usf/data_acquisition/hw4/gates.txt' DELIMITER '|';

select distinct user_id from posts;

select user_id, post_id, created_time, message
from posts
